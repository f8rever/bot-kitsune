...
function changeStoreLanguage(lang) {
    ...
    document.querySelectorAll('.header-lang-btn, .lang-pill').forEach(btn => {
...
function initCatalogApp() {
    ...
    const uiTranslations = {
        pt: {
            ...
            vault_status: "Protegido",
            catalog_header_title: "Catálogo de Itens Disponíveis",
            search_placeholder: "Buscar skin, campeão, pacote...",
            ...
            label_sender_acc: "Conta Riot Enviadora",
            sender_placeholder: "Username:Password",
            label_add_pass: "Senha Adicional (Opcional)",
            pass_placeholder: "Senha",
            label_token_url: "Token / URL da Sessão",
            token_placeholder: "Cole o token de sessão ou link...",
            label_recipient: "Destinatário do Presente (Riot ID)",
            recipient_placeholder: "Nickname#TAG",
            qa_check_rp: "Checar Saldo RP",
            qa_check_rp_sub: "Consultar saldo da conta enviadora",
            qa_send_friend: "Enviar Amizade",
            qa_send_friend_sub: "Adicionar Riot ID do destinatário",
            qa_dispatch: "Enviar Presente Direto",
            qa_dispatch_sub: "Disparar item selecionado",
            tab2_title: "Histórico de Pedidos & Transações",
            tab2_desc: "Acompanhe todos os disparos de presentes e compras executadas pela plataforma.",
            tab2_table_title: "Registros de Envio",
            tab2_btn_export: "Exportar Log",
            tab2_btn_clear: "Limpar Log",
            tab2_th_sender: "Remetente",
            tab2_th_recipient: "Destinatário",
            tab2_th_item: "Item",
            tab2_th_cost: "Custo (RP)",
            tab2_th_date: "Data do Pedido",
            tab2_th_completion: "Conclusão",
            tab2_th_status: "Status",
            tab2_th_actions: "Ações",
            tab3_title: "Cofre de Contas & Chaves API",
            tab3_desc: "Gerencie suas contas de envio Riot salvas e chaves de resolução de Captcha.",
            tab3_cred_title: "Gerenciador de Credenciais",
            tab3_cred_label: "Credencial Riot (user:pass)",
            tab3_btn_save_acc: "Salvar Conta",
            tab3_btn_clear_acc: "Limpar Todas as Contas",
            tab3_captcha_title: "Chave Captcha Solver",
            tab3_captcha_label: "Chave CapMonster / 2Captcha",
            tab3_captcha_placeholder: "Cole sua chave API",
            tab3_btn_save_captcha: "Salvar Chave Captcha",
            tab3_table_title: "Contas Riot Cadastradas",
            tab3_th_userpass: "Usuário:Senha",
            tab3_th_region: "Região",
            tab3_th_rp_balance: "Saldo RP",
            tab3_th_rp_ordered: "RP Pedido",
            tab3_th_rp_remaining: "RP Restante",
            tab3_th_actions: "Ações",
            tab4_title: "Rede de Amigos & Disparos em Massa",
            tab4_desc: "Gerencie amizades do League of Legends e solicite envios e mensagens em lote.",
            tab4_ops_title: "Operações de Amizade",
            tab4_op_acc_label: "Conta Operadora (user:pass)",
            tab4_btn_fetch_friends: "Carregar Amigos",
            tab4_btn_accept_all: "Aceitar Todos os Pedidos",
            tab4_mass_msg_label: "Mensagem de Chat em Massa",
            tab4_mass_msg_placeholder: "Digite a mensagem para todos os amigos...",
            tab4_btn_send_mass_msg: "Disparar Mensagens",
            tab4_import_list_label: "Lista de Pedidos em Massa (.txt)",
            tab4_btn_import_list: "Importar Lista (Máx 50)",
            tab4_btn_clear_friends: "Limpar Amigos",
            tab4_table_title: "Lista de Amigos & Solicitações",
            tab4_search_placeholder: "Filtrar por Riot ID ou Tag...",
            tab4_th_riot_id: "Riot ID (Nome#TAG)",
            tab4_th_status: "Status",
            tab4_th_time: "Tempo de Amizade",
            tab4_th_actions: "Ações",
            cart_drawer_title: "SEU CARRINHO DE PRESENTES",
            cart_riot_rule_title: "Regra de Entrega da Riot Games:",
            cart_riot_rule_desc: "O destinatário precisa ser amigo da conta enviadora há pelo menos <b>24 horas</b> no League of Legends para que o presente seja liberado pela Riot.",
            cart_empty_msg: "Seu carrinho está vazio. Adicione itens do catálogo!",
            cart_recipient_label: "Destinatário do Presente (Riot ID)",
            cart_riot_name_placeholder: "Nome no LoL",
            cart_riot_tag_placeholder: "TAG (ex: BR1)",
            cart_msg_label: "Mensagem do Presente (Opcional)",
            cart_msg_placeholder: "Mensagem personalizada in-game...",
            cart_total_items_label: "Total de Itens:",
            cart_cost_rp_label: "Custo em RP:",
            cart_total_pay_label: "Total a Pagar:",
            cart_btn_dispatch: "FINALIZAR E ENVIAR FILA",
            cart_clear_all: "Limpar Carrinho",
            modal_skin_subtitle: "Escolha entre a Skin Base, o Pacote Croma Completo ou Cromas Individuais avulsos:",
            modal_skin_base_badge: "SKIN BASE",
            modal_skin_base_title: "Skin Base",
            modal_skin_base_desc: "Inclui apenas o modelo e efeitos visuais da skin original.",
            modal_add_cart: "ADICIONAR AO CARRINHO",
            modal_send_direct: "ENVIAR DIRETO",
            modal_bundle_badge: "PACOTE COMPLETO · RUBI EXCLUSIVO",
            modal_bundle_title: "Pacote Croma Completo",
            modal_perk_base: "Skin Base Inclusa",
            modal_perk_chromas: "Todos os Cromas Oficiais",
            modal_perk_ruby: "Croma Rubi Exclusivo do Pacote",
            modal_add_bundle: "ADICIONAR PACOTE",
            modal_send_bundle_direct: "ENVIAR PACOTE DIRETO",
            modal_chromas_title: "Cromas Individuais (290 RP cada)",
            modal_chromas_subtitle: "Já tem a skin? Escolha e envie apenas os cromas avulsos que desejar:"
        },
        en: {
            nav_tab1: "Store & Catalog",
            nav_tab2: "Order History",
            nav_tab3: "Accounts Vault",
            nav_tab4: "Friends Network",
            server_other_header: "OTHER REGIONS",
            btn_cart: "CART",
            ...
            live_status: "Live",
            quota_status: "Limit: 10",
            vault_status: "Protected",
            ...
            label_token_url: "Session Token / URL",
            token_placeholder: "Paste session token or link...",
            label_recipient: "Gift Recipient (Riot ID)",
            recipient_placeholder: "Nickname#TAG",
            qa_check_rp: "Check RP Balance",
            qa_check_rp_sub: "Check sender account balance",
            qa_send_friend: "Send Friend Request",
            qa_send_friend_sub: "Add recipient Riot ID",
            qa_dispatch: "Direct Send Gift",
            qa_dispatch_sub: "Dispatch selected item",
            tab2_title: "Order History & Transactions",
            tab2_desc: "Track all gift dispatches and purchases executed by the platform.",
            tab2_table_title: "Delivery Records",
            tab2_btn_export: "Export Log",
            tab2_btn_clear: "Clear Log",
            tab2_th_sender: "Sender",
            tab2_th_recipient: "Recipient",
            tab2_th_item: "Item",
            tab2_th_cost: "Cost (RP)",
            tab2_th_date: "Order Date",
            tab2_th_completion: "Completion",
            tab2_th_status: "Status",
            tab2_th_actions: "Actions",
            tab3_title: "Accounts Vault & API Keys",
            tab3_desc: "Manage your saved Riot sender accounts and Captcha solver keys.",
            tab3_cred_title: "Credentials Manager",
            tab3_cred_label: "Riot Credential (user:pass)",
            tab3_btn_save_acc: "Save Account",
            tab3_btn_clear_acc: "Clear All Accounts",
            tab3_captcha_title: "Captcha Solver Key",
            tab3_captcha_label: "CapMonster / 2Captcha Key",
            tab3_captcha_placeholder: "Paste your API key",
            tab3_btn_save_captcha: "Save Captcha Key",
            tab3_table_title: "Registered Riot Accounts",
            tab3_th_userpass: "Username:Password",
            tab3_th_region: "Region",
            tab3_th_rp_balance: "RP Balance",
            tab3_th_rp_ordered: "Ordered RP",
            tab3_th_rp_remaining: "Remaining RP",
            tab3_th_actions: "Actions",
            tab4_title: "Friends Network & Mass Dispatch",
            tab4_desc: "Manage League of Legends friendships and request batch delivery and messages.",
            tab4_ops_title: "Friendship Operations",
            tab4_op_acc_label: "Operator Account (user:pass)",
            tab4_btn_fetch_friends: "Load Friends",
            tab4_btn_accept_all: "Accept All Requests",
            tab4_mass_msg_label: "Mass Chat Message",
            tab4_mass_msg_placeholder: "Type message for all friends...",
            tab4_btn_send_mass_msg: "Send Messages",
            tab4_import_list_label: "Mass Order List (.txt)",
            tab4_btn_import_list: "Import List (Max 50)",
            tab4_btn_clear_friends: "Clear Friends",
            tab4_table_title: "Friend List & Requests",
            tab4_search_placeholder: "Filter by Riot ID or Tag...",
            tab4_th_riot_id: "Riot ID (Name#TAG)",
            tab4_th_status: "Status",
            tab4_th_time: "Friendship Time",
            tab4_th_actions: "Actions",
            cart_drawer_title: "YOUR GIFT CART",
            cart_riot_rule_title: "Riot Games Delivery Rule:",
            cart_riot_rule_desc: "The recipient must be friends with the sending account for at least <b>24 hours</b> in League of Legends for the gift to be unlocked by Riot.",
            cart_empty_msg: "Your cart is empty. Add items from the catalog!",
            cart_recipient_label: "Gift Recipient (Riot ID)",
            cart_riot_name_placeholder: "LoL Summoner Name",
            cart_riot_tag_placeholder: "TAG (e.g. NA1)",
            cart_msg_label: "Gift Message (Optional)",
            cart_msg_placeholder: "Custom in-game message...",
            cart_total_items_label: "Total Items:",
            cart_cost_rp_label: "RP Cost:",
            cart_total_pay_label: "Total to Pay:",
            cart_btn_dispatch: "CHECKOUT & SEND QUEUE",
            cart_clear_all: "Clear Cart",
            modal_skin_subtitle: "Choose between Base Skin, Full Chroma Bundle, or Individual Chromas:",
            modal_skin_base_badge: "BASE SKIN",
            modal_skin_base_title: "Base Skin",
            modal_skin_base_desc: "Includes only the model and visual effects of the original skin.",
            modal_add_cart: "ADD TO CART",
            modal_send_direct: "DIRECT SEND",
            modal_bundle_badge: "COMPLETE BUNDLE · EXCLUSIVE RUBY",
            modal_bundle_title: "Complete Chroma Bundle",
            modal_perk_base: "Base Skin Included",
            modal_perk_chromas: "All Official Chromas",
            modal_perk_ruby: "Exclusive Bundle Ruby Chroma",
            modal_add_bundle: "ADD BUNDLE",
            modal_send_bundle_direct: "DIRECT SEND BUNDLE",
            modal_chromas_title: "Individual Chromas (290 RP each)",
            modal_chromas_subtitle: "Already own the skin? Pick and send individual chromas:"
        }
    };

    function applyUiTranslations(lang) {
        const isEn = (lang === 'en' || selectedLanguage === 'en');
        const activeLang = isEn ? 'en' : 'pt';
        const dict = uiTranslations[activeLang] || uiTranslations.pt;
        ...
        if (searchInput) {
            if (isEn) {
                ...
                else searchInput.placeholder = 'Search skins, champions, passes, bundles...';
            } else {
                ...
                else searchInput.placeholder = 'Buscar skins, campeões, passes, pacotes...';
            }
        }
